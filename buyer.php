...
<nav class="fh5co-cata" role="navigation">
	...
	$st= $pdo->query("SELECT * FROM post  LIMIT {$offset},{$limit}");
...
if ($st2) {
    ...
    if ($row2) {
        ...
        // Possibly log an error or set a default value for $name
        $name = "Unknown"; // Example: Setting a default value
    }
} else {
    // Handle the case where the query failed
    // Possibly log an error or perform error handling
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                  <div class="inner-content clearfix">
									  ...
									  <form action="contact.php" method="post" class='read-more pull-right'>
